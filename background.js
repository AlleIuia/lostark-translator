...
function mergeWithDeleted(base, user) {
  ...
  const result = { classes: [], engravings: [], _orphanBuilds: [] };
...
async function loadDefaultDictionaries() {
  ...
  let merged = { classes: [], engravings: [], _orphanBuilds: [] };
...
async function syncFromUrls(urls) {
  ...
  const existing = userData || { classes: [], engravings: [], _orphanBuilds: [], _deleted: [] };
...
async function rebuildStorage() {
  ...
  const fullData = mergeWithDeleted(
    baseData || { classes: [], engravings: [], _orphanBuilds: [] },
    userData || { classes: [], engravings: [], _orphanBuilds: [], _deleted: [] }
  );
